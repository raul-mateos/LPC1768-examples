...
void adc_cfg_ext_cnv(void);
void ext_cnv_timer_cfg(float f_s);

int main() {
  ext_cnv_timer_cfg(20.0E3);  // f_sample = 20 Ksps
...
// Using CAP0.1 (P1.27) as external conversion request
...
void adc_cfg_ext_cnv(void) {
  ...
  // Configure P1.27 as CAP0.1 function
  LPC_PINCON->PINSEL3  &= ~(0x3 << 22); // Clear bits 23:22...
  LPC_PINCON->PINSEL3  |=  (0x3 << 22); // P1.27 as CAP0.1
